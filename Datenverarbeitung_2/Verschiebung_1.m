...
xlabel('Zeit in [s]'); % label x-axis
ylabel('Flussverkettung in [WB]'); % label y-axis
sgtitle('Anregung mit 1Hz beim MRAS');
...
sgtitle('Anregung mit 1Hz beim RLS');
...
xlabel('Zeit in [s]'); % label x-axis
ylabel('Flussverkettung in [WB]'); % label y-axis
sgtitle('Anregung mit 1Hz beim EKF');
figure(4);
subplot(2,1,1);
...
xlabel('Zeit in [s]'); % label x-axis
ylabel('Flussverkettung in [WB]'); % label y-axis
sgtitle('Anregung mit 1Hz beim LB');
